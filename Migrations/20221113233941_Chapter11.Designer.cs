...
namespace TermProject.Migrations
{
    ...
    [Migration("20221113233941_Chapter11")]
            ...
            modelBuilder.Entity("TermProject.Models.Pokemon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PokemonId = 1,
                            Attack = 49,
                            DateAdded = new DateTime(2022, 11, 13, 18, 39, 40, 667, DateTimeKind.Local).AddTicks(6802),
                            Defense = 49,
                            Hp = 45,
                            Name = "Bulbasaur",
                            PokedexNumber = 1,
                        ...
                        new
                        {
                            PokemonId = 2,
                            Attack = 62,
                            DateAdded = new DateTime(2022, 11, 13, 18, 39, 40, 671, DateTimeKind.Local).AddTicks(4006),
                            Defense = 63,
                            Hp = 60,
                            Name = "Ivysaur",
                            PokedexNumber = 2,
                        ...
                        new
                        {
                            PokemonId = 3,
                            Attack = 100,
                            DateAdded = new DateTime(2022, 11, 13, 18, 39, 40, 671, DateTimeKind.Local).AddTicks(4129),
                            Defense = 123,
                            Hp = 80,
                            Name = "Venusaur",
                            PokedexNumber = 3,
